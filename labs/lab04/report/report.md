...
![полноый путь домашнего каталога](image/1.png){ #fig:001 width=70% }
...
![Команды ls и ls -l](image/2.png){ #fig:002 width=70% }

![Командa ls -a](image/3.png){ #fig:003 width=70% }
...
![Проверка подкаталога cron и определение владельца и домашнем каталоге](image/4.png){ #fig:004 width=70% }
...
![Листинг команд для пункта 3](image/5.png){ #fig:005 width=70% }
...
![Просмотр содержимого не только указанного каталога, но и подкаталогов](image/6.png){ #fig:006 width=70% }
...
![Сортировка по времени последнего изменения](image/7.png){ #fig:007 width=70% }

6. Используйте команду man для просмотра описания следующих команд: cd, pwd, mkdir, rmdir, rm. (рис 8)

![man вместе с основными командами](image/8.png){ #fig:008 width=70% }

7. Используя команду history посмотрим на последние команды и вызовем команду 172 (рис. 9)

![history + !172](image/9.png){ #fig:009 width=70% }

Вызов команды 177 и модификация команды 172: замена -l на -a (рис. 10) 

![Вызов команды 177 и модификация команды 172](image/9.png){ #fig:010 width=70% }
